                                            ...
                                            <select name="tid1" >
                                                <?php
                                                    ...
                                                    if(isset($_POST['submit3']))
                                                    {
                                                        ...
                                                        $db->select_db('proknap');
                                                        $cursor = $db->query( "SELECT T_id from tender where Pr_no=$_POST[req_id] and T_id not in (SELECT T_id from ext1 where Pr_no=$_POST[req_id]) and status<5");
                                                        if ($db->error) {
                                                            echo $db->error.PHP_EOL;
                                                        }
                                                        //echo "<select>";
                                        ...
                                        <select name="tid2" >
                                            <?php
                                                ...
                                                if(isset($_POST['submit2']))
                                                {
                                                    ...
                                                    $db->select_db('proknap');
                                                    $cursor = $db->query("SELECT tender.T_id from ext1 join tender on tender.T_id=ext1.T_id and tender.Pr_no=ext1.Pr_no where tender.Pr_no=$_POST[req_id] and tender.T_id not in (SELECT ext2.T_id from ext2 where ext2.Pr_no=$_POST[req_id]) and tender.status<5");
                                                    if ($db->error) {
                                                        echo $db->error.PHP_EOL;
                                                    }
                                                    //echo "<select>";
