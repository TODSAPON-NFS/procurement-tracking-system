                ...
                <table class="table user-list">
                  ...
                  <tbody>
                    <?php
                        ...
                        $cursor = $db->query("select tender.Pr_no,pr.Pr_date,T_id,tender.Status_updated_date from tender join pr on tender.Pr_no=pr.Pr_no where tender.Pr_no in(SELECT assign.Pr_no FROM assign where do='$_SESSION[user_name]') AND Status=12");
                        if ($db->error) {
                        ...
                        while($val = $cursor->fetch_assoc()){
                          ...
                          echo "<td>".$val['T_id']."</td>";
                          echo "<td>".$val['Status_updated_date']."</td>";
                          echo "</tr>";
                        }
                        $cursor->close();
                    ?>
