    ...
    <div class="row">
      <nav class="col-sm-3" id="myScrollspy" >
        <ul class="nav nav-pills nav-stacked" style="font-weight:900;">
          <li class="active"><a class="left" href="#section1">View Unassigned PRs</a></li>
          <li ><a class="left" href="#section2">View Assigned PR</a></li>
          <li ><a class="left" href="#section3">Assign Task</a></li>
      ...
      <div class="col-sm-9">
        <div id="section1">
          <h1 style="margin-left:20px;margin-top:30px;padding-top:30px;">View Unassigned PRs</h1>
          <p style="margin-left:20px;margin-top:10px;">
            <object type="text/html" data="http://localhost/proknap/html/partials/pr-unassigned.php" width="800px" height="600px" style="overflow:auto;border:0px ridge blue">
            </object>
          </p>
        </div>
          <div id="section2">
            <h1 style="margin-left:20px;margin-top:30px;padding-top:30px;">View Assigned PR</a></li>
            <p style="margin-left:20px;margin-top:10px;">
              <object type="text/html" data="http://localhost/proknap/html/partials/pr-view-req.php" width="800px" height="600px" style="overflow:auto;border:0px ridge blue">
              </object>
            </p>
          </div>
        <div id="section3" style="height:800px;">
          <h1 style="margin-left:20px;margin-top:30px;padding-top:30px;" >Dealing Officers' Workload</h1>
          <p>
            <object type="text/html" data="http://localhost/proknap/html/partials/pr-workload.php" width="800px" height="280px" style="overflow:auto;border:0px ridge blue">
            </object>
              <h1 style="margin-left:20px;margin-top:80px;">Assign PR</h1>
            <object type="text/html" data="http://localhost/proknap/html/partials/assign-task.php" width="800px" height="280px" style="overflow:auto;border:0px ridge blue">
            </object>
          </p>
        </div>
      </br>
